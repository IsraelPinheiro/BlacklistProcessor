...
class BlacklistProcessor(object):
    def __init__(self):
    ...
    def banner(self):
        ...
        print(r"======================================================================================================")
        print(r"||                                                                                                  ||")
        print(r"||  __________.____     ____  __.__________                                                         ||")
        print(r"||  \______   \    |   |    |/ _|\______   \_______  ____   ____  ____   ______ _________________   ||")
        print(r"||   |    |  _/    |   |      <   |     ___/\_  __ \/  _ \_/ ___\/ __ \ /  ___//  ___/  _ \_  __ \  ||")
        print(r"||   |    |   \    |___|    |  \  |    |     |  | \(  <_> )  \__\  ___/ \___ \ \___ (  <_> )  | \/  ||")
        print(r"||   |______  /_______ \____|__ \ |____|     |__|   \____/ \___  >___  >____  >____  >____/|__|     ||")
        print(r"||          \/        \/       \/                              \/    \/     \/     \/               ||")
        print(r"||                                                                                                  ||")
        print(r"||                                    BlacklistProcessor v0.8 Beta                                  ||")
